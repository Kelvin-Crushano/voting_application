    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-item">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
          ...
          <div data-i18n="Layouts">Citizenship</div>
        </a>

        <ul class="menu-sub">
          <li class="menu-item">
            <a href="{{ route('citizenship') }}" class="menu-link">
              <div data-i18n="Without menu">Citizens</div>
            </a>
          </li>
        </ul>
      </li>
      <li class="menu-item">
        ...
        <ul class="menu-sub">
          <li class="menu-item">
            <a href="{{ route('voting') }}"  class="menu-link">
