            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="/gs_login" class="app-brand-link gap-2">
                  <span class="app-brand-text demo text-body text-uppercase fw-bolder">Voter Login</span>
                </a>
              </div>
              <!-- /Logo -->
              ...
              <form id="formAuthentication" class="mb-3" method="POST" action="{{ route('voter_login_system') }}">
                {{ csrf_field() }}
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" name="nicNo" id="nicNo" placeholder="Enter your NIC no" value="{{ old('nicNo') }}">
                  @error('nicNo')
