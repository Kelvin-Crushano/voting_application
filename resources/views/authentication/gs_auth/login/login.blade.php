            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="/gs_login" class="app-brand-link gap-2">
                  <span class="app-brand-text demo text-body text-uppercase fw-bolder">GS Login</span>
                </a>
              </div>
              <!-- /Logo -->
              ...
              <form id="formAuthentication" class="mb-3" method="POST" action="{{ route('gs_login_system') }}">
                {{ csrf_field() }}
